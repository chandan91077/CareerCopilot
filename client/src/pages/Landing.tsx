...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[#070708] text-zinc-100 selection:bg-indigo-500/30 selection:text-indigo-200 overflow-x-hidden font-sans">
      ...
      <header className="fixed top-5 left-1/2 -translate-x-1/2 w-[90%] max-w-6xl z-50">
        <div className="bg-[#121214]/80 border border-zinc-800/80 rounded-full px-6 py-3 flex items-center justify-between backdrop-blur-md shadow-lg shadow-black/50">
          ...
          <div className="flex items-center gap-3">
            <Link to="/login" className="text-xs font-bold text-zinc-300 hover:text-white transition-colors px-3 py-1.5">
              Log in
            </Link>
            <Link 
              to="/register" 
      ...
      <section className="relative pt-36 pb-20 px-6 max-w-6xl mx-auto text-center flex flex-col items-center justify-center min-h-[85vh]">
        ...
        <h1 className="text-4xl md:text-6xl font-black tracking-tight leading-[1.1] max-w-4xl bg-gradient-to-b from-white via-zinc-100 to-zinc-400 bg-clip-text text-transparent">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 mt-10">
          ...
          <a 
            href="#download" 
            className="w-full sm:w-auto px-8 py-4 bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 hover:border-zinc-700 text-zinc-300 hover:text-white text-sm font-semibold rounded-full transition-all flex items-center justify-center gap-2"
          >
      ...
      <section id="how-it-works" className="py-24 px-6 max-w-6xl mx-auto border-t border-zinc-900/60 relative">
        <div className="text-center max-w-xl mx-auto mb-16">
          ...
          <p className="text-zinc-500 text-xs mt-2">Get ready in minutes with our simple four-step analysis loop.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {steps.map((step) => (
            <div 
              key={step.num} 
              className="bg-[#121214]/60 border border-zinc-800 hover:border-indigo-500/30 rounded-3xl p-6 relative shadow-md transition-all hover:scale-[1.02]"
            >
              <div className="absolute -top-4 left-6 w-8 h-8 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center font-bold text-xs text-zinc-400">
                {step.num}
              </div>
              <div className="mb-6 mt-2 p-3 rounded-xl bg-zinc-900/60 w-fit border border-zinc-800">
                {step.icon}
              </div>
      ...
      <section id="shortcuts" className="py-24 px-6 max-w-6xl mx-auto border-t border-zinc-900/60">
        <div className="text-center max-w-xl mx-auto mb-16">
          ...
          <p className="text-zinc-500 text-xs mt-2">Use built-in keyboard mappings during sessions for swift, seamless operations.</p>
        </div>
      ...
      <section id="features" className="py-24 px-6 max-w-6xl mx-auto border-t border-zinc-900/60">
        <div className="text-center max-w-xl mx-auto mb-16">
          ...
          <p className="text-zinc-500 text-xs mt-2">Designed from the ground up for high fidelity, privacy, and visual appeal.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feat) => (
            <div 
              key={feat.title} 
              className="bg-[#121214]/50 border border-zinc-800 hover:border-zinc-700 rounded-3xl p-6 shadow-md flex items-start gap-4 transition-all hover:border-zinc-800"
            >
      ...
      <section id="pricing" className="py-24 px-6 max-w-6xl mx-auto border-t border-zinc-900/60">
        <div className="text-center max-w-xl mx-auto mb-16">
          ...
          <p className="text-zinc-500 text-xs mt-2">Sign up, run tests in our sandbox playground, and upgrade whenever you are ready.</p>
        </div>
      ...
      <section id="download" className="py-24 px-6 max-w-6xl mx-auto border-t border-zinc-900/60 text-center relative overflow-hidden">
