            ...
            <div>
              ...
              <div className="flex flex-col gap-2 mt-1">
                ...
                <a 
                  ...
                  className="w-fit px-4 py-2 mt-2 bg-white text-indigo-700 hover:bg-indigo-50 font-extrabold text-xs rounded-xl shadow-md transition-all flex items-center gap-1.5 cursor-pointer"
                >
